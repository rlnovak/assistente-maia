    ...
    <div className="flex h-screen overflow-hidden bg-maia-offwhite">
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <header className="md:hidden flex items-center gap-3 px-4 py-3 border-b border-maia-offwhite2 bg-white">
          ...
          <span className="font-serif text-lg text-maia-escuro flex-1">
            Ma<em className="italic text-maia-dourado">IA</em>
          </span>
          <a
            href="/stories"
            className="flex items-center gap-1 text-xs text-maia-cinza hover:text-maia-dourado transition px-2 py-1 rounded-md border border-maia-cinza-claro hover:border-maia-dourado/50"
          >
